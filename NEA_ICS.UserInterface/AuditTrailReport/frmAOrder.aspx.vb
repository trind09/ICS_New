...
Partial Public Class frmAOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            AccessRights = clsCommonFunction.AssignAccessRights(Cache(Session(ESession.UserID.ToString) & Session(ESession.StoreID.ToString) & "AccessRights"), _
                                clsCommonFunction.moduleID.Order)
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        ...
        rvr.LocalReport.DataSources.Add(New ReportDataSource("AOrderDetails", ObjectDataSource1))
        ...
        Dim p5 As New ReportParameter("OrderBy", ddlSortBy.SelectedItem.Text)
        ...
        If NoRecordFond = "Y" Then
            ...
            Dim bp5 As New ReportParameter("AuditTrail", "Order")
            Dim bp6 As New ReportParameter("TransType", "")
            Dim bp7 As New ReportParameter("OrderBy", ddlSortBy.SelectedItem.Text)
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AOrder.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        ...
        If NoRecordFond = "Y" Then
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AOrder.xls")
            Response.BinaryWrite(bytValueBlank)
            Response.Flush()
            Response.End()
    ...
    Protected Sub ObjectDataSource1_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Selected
        Dim returnList As List(Of AOrderDetails) = e.ReturnValue
