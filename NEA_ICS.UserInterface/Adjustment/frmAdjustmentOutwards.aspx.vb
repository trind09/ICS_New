...
''' <summary>
''' Code behind for frmAdjustmentOutwards Page;
''' 28Feb09 - KG;
''' </summary>
''' <remarks>
''' CHANGE LOG:
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not Page.IsPostBack Then
                ...
                If CacheListIsEmpty(Cache(Session(ESession.StoreID.ToString) & ECache.AdjustOutList), GetType(AdjustDetails)) Then GetAdjustList(Cache(Session(ESession.StoreID.ToString) & ECache.AdjustOutList), Session(ESession.StoreID.ToString), ADJUSTOUT, ALL)
                ...
                ' New Tab
                BindDropDownList(ddlDocType, GetCommonDataByCodeGroup(Cache(Session(ESession.StoreID.ToString) & "dtCommon"), codeGroup.OutwardsDocType, OPEN), "CommonCodeID", "CommonCodeDescription")
                ...
                BindDropDownList(ddlRptDocumentNo, Cache(Session(ESession.StoreID.ToString) & ECache.AdjustOutList), "AdjustID", "AdjustID")
            End If
    ...
    Private Sub btnAddAdjustItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddAdjustItem.Click
        Try
            If ValidAdjust() Then
                ...
                'btnAddItem_Click(sender, e) [NOT NEEDED]
                'If CacheListIsEmpty(Cache(Session(ESession.StoreID.ToString) & ECache.ItemList), GetType(ItemDetails)) Then GetItemList(Cache(Session(ESession.StoreID.ToString) & ECache.ItemList), Session(ESession.StoreID.ToString))
...
#Region "Print Tab"
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        ...
        Dim p4 As New ReportParameter("ReportTitle", "Adjustment Outwards Report")
        ...
        Response.AddHeader("content-disposition", "attachment;filename=AdjustmentOutward.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        ...
        Response.AddHeader("content-disposition", "attachment;filename=AdjustmentOutward.xls")
        Response.BinaryWrite(bytValue)
        Response.Flush()
        Response.End()
    End Sub
    ...
    Protected Sub ObjectDataSource1_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles ObjectDataSource1.Selecting
        ...
        e.InputParameters("type") = ADJUSTOUT
...
#Region " Sub Procedures and Functions "
    ...
    ''' ddMMMyy  AuthorName  RefID  Description;
    ''' </remarks>
    Private Sub AddAdjustItem(ByRef PlaceHolder As DynamicControlsPlaceholder, ByVal AdjustItemDetails As AdjustItemDetails, ByVal UserControlName As String, ByVal adjustType As String)
        Try
