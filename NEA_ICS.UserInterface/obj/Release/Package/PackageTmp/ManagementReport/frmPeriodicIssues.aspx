<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmPeriodicIssues.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmPeriodicIssues" ValidateRequest="true" %>
        ...
        <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
            <tr>
                <td class="moduleTitleBorder">
                    Management Report > Periodic Issues
                </td>
            </tr>
        </table>
        <br />
                ...
                <ContentTemplate>
                    <table class="tblModule" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td class="colDesc" width="80%" colspan="3">
                                <asp:DropDownList ID="ddlConsumer" runat="server" CssClass="formsComboLarge">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                        ...
                        <LocalReport ReportPath="ManagementReport\rptMR007PeriodIssues.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MR007PeriodIssuesDetails" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetMR007PeriodIssues"
