...
Partial Public Class frmTransactionListing
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        Try
            ...
            End If
            Dim paraWithDirectIssue As String
            If ckbDirectIssue.Checked Then
                paraWithDirectIssue = "Yes"
            Else
                paraWithDirectIssue = "No"
            End If
            ...
            Dim p6 As New ReportParameter("WithDirectIssue", paraWithDirectIssue)
