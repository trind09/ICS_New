...
Partial Public Class frmAStockTransaction
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            AccessRights = clsCommonFunction.AssignAccessRights(Cache(Session(ESession.UserID.ToString) & Session(ESession.StoreID.ToString) & "AccessRights"), _
                                clsCommonFunction.moduleID.StockTransactions)
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        ...
        rvr.LocalReport.DataSources.Add(New ReportDataSource("AStockTransactionDetails", ObjectDataSource1))
        ...
        Dim p5 As New ReportParameter("TransType", ddlTransType.SelectedItem.ToString())
        ...
        If NoRecordFond = "Y" Then
            ...
            Dim bp5 As New ReportParameter("AuditTrail", "Stock Transaction")
            Dim bp6 As New ReportParameter("TransType", ddlTransType.SelectedItem.ToString())
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AStockTransaction.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        ...
        If NoRecordFond = "Y" Then
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AStockTransaction.xls")
            Response.BinaryWrite(bytValueBlank)
            Response.Flush()
            Response.End()
    ...
    Protected Sub ObjectDataSource1_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles ObjectDataSource1.Selecting
        ...
        e.InputParameters("TransType") = ddlTransType.SelectedValue.ToString()
        e.InputParameters("orderBy") = ddlSortBy.SelectedValue.ToString()
    End Sub
    Protected Sub ObjectDataSource1_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Selected
        Dim returnList As List(Of AStockTransactionDetails) = e.ReturnValue
