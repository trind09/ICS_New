<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmNewUsers.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmNewUsers" ValidateRequest="true" %>
        ...
        <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
            <tr>
                <td class="moduleTitleBorder">
                    User Audit Report &gt; List of New Accounts Created
                </td>
            </tr>
        </table>
        <br />
        ...
        <asp:UpdatePanel ID="uplItem" runat="server">
            <ContentTemplate>
                ...
                <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                    ...
                    <LocalReport ReportPath="UserAuditReport\rptAR004GetNewUserCreated.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoleDetails" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetNewUserAccountList"
