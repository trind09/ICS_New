<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmTransactionListing.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmTransactionListing" ValidateRequest="true" %>
        ...
        <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
            <tr>
                <td class="moduleTitleBorder">
                    Management Report > Stock Transaction Listing
                </td>
            </tr>
        </table>
        <br />
