...
Partial Public Class frmInvalidAccountLogin
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        Try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=InvalidUserLoginAttempts.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        Try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=InvalidUserLoginAttempts.xls")
            Response.BinaryWrite(bytValue)
            Response.Flush()
            Response.End()
