...
<body>
    ...
    <div>
        ...
        <act:TabContainer ID="tbcRole" Width="98%" Font-Bold="true" Font-Size="Medium" runat="server"
            ForeColor="#4D36C2" BackColor="#FFFFFF" Font-Names="Verdana" ActiveTabIndex="1"
            Visible="False">
           ...
           <ContentTemplate>
                ...
                <ContentTemplate>
                    ...
                    <asp:BoundField DataField="SoeID" HeaderText="SoeID" SortExpression="UserRoleSoeID" />
                    </Columns>
                    </asp:GridView>
                    <br />
                    <div align="center">
                                ...
                                <table class="tblModule" cellspacing="1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="colDesc" width="80%">
                                            ...
                                            <%--NRIC Mask -- Start--%>
                                            <asp:HiddenField ID="hdnNRIC" runat="server" />
                                            <%--NRIC Mask -- End--%>
                                        ...
                                        <td class="colDesc" width="30%">
                                            <asp:TextBox ID="txtSOEID" runat="server" CssClass="formsText"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="colMod" width="20%">
