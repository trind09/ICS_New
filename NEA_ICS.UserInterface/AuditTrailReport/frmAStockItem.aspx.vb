...
Partial Public Class frmAStockItem
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            AccessRights = clsCommonFunction.AssignAccessRights(Cache(Session(ESession.UserID.ToString) & Session(ESession.StoreID.ToString) & "AccessRights"), _
                                clsCommonFunction.moduleID.StockItem)
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        ...
        rvr.LocalReport.DataSources.Add(New ReportDataSource("AStockItemDetails", ObjectDataSource1))
        ...
        Dim p4 As New ReportParameter("AuditType", ddlAuditType.SelectedItem.Text)
        Dim p5 As New ReportParameter("FilterByStatus", IIf(chkStatusFilter.Checked, "Yes", "No").ToString())
        ...
        If NoRecordFond = "Y" Then
            ...
            Dim bp4 As New ReportParameter("AuditType", ddlAuditType.SelectedItem.Text)
            Dim bp5 As New ReportParameter("AuditTrail", "Stock Item")
            ...
            Dim bp10 As New ReportParameter("FilterByStatus", IIf(chkStatusFilter.Checked, "Yes", "No").ToString())
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AStockItem.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        ...
        If NoRecordFond = "Y" Then
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AStockItem.xls")
            Response.BinaryWrite(bytValueBlank)
            Response.Flush()
            Response.End()
    ...
    Protected Sub ObjectDataSource1_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles ObjectDataSource1.Selecting
        ...
        e.InputParameters("auditType") = ddlAuditType.SelectedValue.ToString()
        If Me.ckbTransDate.Checked Then
        ...
        End If
        e.InputParameters("itemStatus") = chkStatusFilter.Checked 'tin-todo
        e.InputParameters("orderBy") = ddlSortBy.SelectedValue

    End Sub

    Protected Sub ObjectDataSource1_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Selected
        Dim returnList As List(Of AStockItemDetails) = e.ReturnValue
    ...
    Protected Sub ddlAuditType_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlAuditType.SelectedIndexChanged
        If ddlAuditType.SelectedValue = "Edit" Then
            chkStatusFilter.Visible = True
            lblStatusFilter.Visible = True
        Else
            chkStatusFilter.Visible = False
