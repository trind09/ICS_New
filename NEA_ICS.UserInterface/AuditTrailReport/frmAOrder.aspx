<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="true" CodeBehind="frmAOrder.aspx.vb" Inherits="NEA_ICS.UserInterface.frmAOrder" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
                <tr>
                    <td class="moduleTitleBorder">Audit Trail Report > Order
                    </td>
                </tr>
            </table>
            <br />
                ...
                <asp:UpdatePanel ID="uplItem" runat="server">
                    <ContentTemplate>
                        <table class="tblModule" cellspacing="1">
                            <tr>
                                <td class="colMod" width="20%">Date From (dd/mm/yyyy) *
                                </td>
                                ...
                                <td class="colMod" width="20%">Date To (dd/mm/yyyy) *
                                </td>
                                <td class="colDesc" width="30%">
                            ...
                            <tr>
                                <td class="colMod" width="20%">Sort By
                                </td>
                                <td class="colDesc" width="80%" colspan="3">
                                    <asp:DropDownList ID="ddlSortBy" runat="server" CssClass="formsCombo">
                                        <asp:ListItem Text="Entry Date" Value="ENTRYDATE" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="Order Date" Value="ORDERDATE"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4" class="errMsg">* denotes mandatory fields
                                </td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                            ...
                            <LocalReport ReportPath="AuditTrailReport\rptAOrder.rdlc">
                                <DataSources>
                                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="AOrderDetails" />
                                </DataSources>
                            </LocalReport>
                        </rsweb:ReportViewer>
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAuditTrailOrder"
