<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AdjustItem.ascx.vb"
    Inherits="NEA_ICS.UserInterface.AdjustItem" %>
...
<table class="tblModule" cellspacing="1">
    ...
    <tr>
        ...
        <td class="colMod" width="20%">
            Total Cost (w/o GST) #<sup>2</sup>
        </td>
        <td class="colDesc" width="30%">
            <asp:TextBox ID="txtTotalCost" runat="server" CssClass="formsTextNum" TabIndex="53" />
            ...
            <asp:RegularExpressionValidator ID="revTotalCost" runat="server" ValidationExpression="^\d{1,15}(\.\d{0,2})?$" ControlToValidate="txtTotalCost" ErrorMessage="2 decimal places"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        <td class="colMod" width="20%">
