<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmUserActivities.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmUserActivities" ValidateRequest="true" %>
        ...
        <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
            <tr>
                <td class="moduleTitleBorder">
                    User Audit Report &gt; List of User Access
                </td>
            </tr>
        </table>
        <br />
        ...
        <asp:UpdatePanel ID="uplItem" runat="server">
            <ContentTemplate>
                    <table class="tblModule" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td class="colDesc" width="80%" colspan="3">
                                <asp:CheckBox ID="checkRetrieveByTimeStamp" runat="server" Text="Exclude Timestamp"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="colMod" width="20%">
                        ...
                        <tr >
                            ...
                            <td class="colDesc" colspan="3" width="80%">
                                <asp:DropDownList ID="ddlFilterBy" runat="server" CssClass="formsComboLarge">
                                </asp:DropDownList>
                            </td>
                        </tr >
                        -->
                ...
                <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                    ...
                    <LocalReport ReportPath="UserAuditReport\rptAR001GetUserActivities.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoleDetails" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetUserActivityList"
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter Name="byTimeStamp" Type="Boolean" DefaultValue="" />
                        <asp:Parameter Name="filterBy" Type="String" DefaultValue="" />
