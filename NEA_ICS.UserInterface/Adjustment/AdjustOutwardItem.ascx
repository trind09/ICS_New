<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AdjustOutwardItem.ascx.vb"
    Inherits="NEA_ICS.UserInterface.AdjustOutwardItem" %>
...
<table class="tblModule" cellspacing="1">
    ...
    <tr>
        ...
        <td class="colDesc" width="30%">
            <asp:LinkButton ID="btnViewDetails" runat="server" CssClass="linkButton" Text="(View Stock Availability)" TabIndex="51" />
        </td>
    </tr>
    <tr>
        <td class="colMod" width="20%">
    ...
    <tr>
        ...
        <td class="colDesc" width="30%">
            ...
            <act:FilteredTextBoxExtender ID="fteAdjustQty" runat="server" TargetControlID="txtAdjustQty" FilterMode="ValidChars" ValidChars="0123456789."></act:FilteredTextBoxExtender>
            <asp:RegularExpressionValidator ID="revAdjustQty" runat="server" ValidationExpression="^\d{1,15}(\.\d{0,2})?$" ControlToValidate="txtAdjustQty" ErrorMessage="2 decimal places"></asp:RegularExpressionValidator>
        </td>
        <td class="colMod" width="20%">
            Receive Quantity (w/o GST) #<sup>2</sup>
        </td>
        <td class="colDesc" width="30%">
            <asp:TextBox ID="txtReceiveQty" runat="server" CssClass="formsTextNum" TabIndex="53" />
            <act:FilteredTextBoxExtender ID="fteTotalCost" runat="server" TargetControlID="txtReceiveQty" FilterMode="ValidChars" ValidChars="0123456789."></act:FilteredTextBoxExtender>
            <asp:RegularExpressionValidator ID="revTotalCost" runat="server" ValidationExpression="^\d{1,15}(\.\d{0,2})?$" ControlToValidate="txtReceiveQty" ErrorMessage="2 decimal places"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        <td class="colMod" width="20%">
        ...
        <td class="colDesc" width="80%" colspan="3">
        <asp:CheckBox ID="checkReceived" runat="server" Text="All above items are returned correctly and received by Store Officer." Visible="false" />
        </td>
    </tr>
</table>
        ...
        <table class="tblModule" cellspacing="1">
           <%-- <tr id="trUnitCost" runat="server" visible="false" >
            ...
            <tr id="trCancel" runat="server" visible="true" >
                ...
                <td class="colDesc" width="80%">
                    <asp:LinkButton ID="btnCancel" runat="server" CssClass="linkButton" Text="[Cancel Item]"  TabIndex="55"/>
                </td>
            </tr>
        </table>
    </ContentTemplate>
