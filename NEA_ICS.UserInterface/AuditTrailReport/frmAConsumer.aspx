<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="true" CodeBehind="frmAConsumer.aspx.vb" Inherits="NEA_ICS.UserInterface.frmAConsumer" %>
            ...
            <asp:UpdatePanel ID="uplItem" runat="server">
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                        ...
                        <LocalReport ReportPath="AuditTrailReport\rptAConsumer.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="AConsumer" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <br />
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAuditTrailAConsumer"
                     TypeName="NEA_ICS.UserInterface.NEA_ICS.WcfService.ServiceClient">
                        <SelectParameters>
                            ...
                            <%--<asp:ControlParameter ControlID="txtDateFrom" Type="String" />
                            <asp:ControlParameter ControlID="txtDateTo"  Type="String" />--%>
                            <%--<asp:ControlParameter ControlID="ckbTransDate" Type="Boolean" />--%>
                        </SelectParameters>
