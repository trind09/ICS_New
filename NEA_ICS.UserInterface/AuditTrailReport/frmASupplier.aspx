<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="true"  CodeBehind="frmASupplier.aspx.vb" Inherits="NEA_ICS.UserInterface.frmASupplier" %>
            ...
            <asp:UpdatePanel ID="uplItem" runat="server">
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                        ...
                        <LocalReport ReportPath="AuditTrailReport\rptASupplier.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="ASupplier" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <br />
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAuditTrailASupplier"
