<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmStockReturn.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmStockReturn" ValidateRequest="true" %>
        ...
        <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
            <tr>
                <td class="moduleTitleBorder">
                    Management Report > Stock Return
                </td>
            </tr>
        </table>
        <br />
            ...
            <asp:UpdatePanel ID="uplItem" runat="server">
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                        ...
                        <LocalReport ReportPath="ManagementReport\rptMR005StockReturn.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MR005StockReturnDetails" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetMR005StockReturn"
