<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmAStockItem.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmAStockItem" ValidateRequest="true" %>
                ...
                <ContentTemplate>
                    <table class="tblModule" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td class="colDesc" width="80%" colspan="3">
                                <asp:DropDownList ID="ddlAuditType" runat="server" CssClass="formsCombo" AutoPostBack="true">
                                ...
                                &nbsp;
                                <asp:CheckBox ID="chkStatusFilter" runat="server" Visible="false" />
                                <asp:Label ID="lblStatusFilter" runat="server" Text="Filter search only on Item Status 'Open' to 'Closed'" Visible="false"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="colMod" width="20%">
                    ...
                    <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                        ...
                        <LocalReport ReportPath="AuditTrailReport\rptAStockItem.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="AStockItemDetails" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAuditTrailStockItem"
