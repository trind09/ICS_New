...
Partial Public Class frmIssueDocumentDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            AccessRights = clsCommonFunction.AssignAccessRights(Cache(Session(ESession.UserID.ToString) & Session(ESession.StoreID.ToString) & "AccessRights"), _
                                    clsCommonFunction.moduleID.IssueDocumentDetails)
    ...
    Protected Sub ObjectDataSource1_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Selected
        Try
            Dim returnList As List(Of MR003IssueDocumentDetails) = e.ReturnValue
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        Try
            ...
            rvr.LocalReport.DataSources.Add(New ReportDataSource("MR003IssueDocumentDetails", ObjectDataSource1))
            ...
            Dim p4 As New ReportParameter("SortBy", ddlSortBy.SelectedValue)
            ...
            Response.AddHeader("content-disposition", "attachment;filename=IssueDocumentDetails.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        Try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=IssueDocumentDetails.xls")
            Response.BinaryWrite(bytValue)
            Response.Flush()
            Response.End()
