<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmInvalidAccountLogin.aspx.vb"
    Inherits="NEA_ICS.UserInterface.frmInvalidAccountLogin" ValidateRequest="true" %>
        ...
        <table class="moduleTitle" width="98%" cellspacing="1" cellpadding="1">
            <tr>
                <td class="moduleTitleBorder">
                    User Audit Report &gt; List of Invalid Users with Login Attempts
                </td>
            </tr>
        </table>
        <br />
            ...
            <asp:UpdatePanel ID="uplItem" runat="server">
                <ContentTemplate>
                    ...
                    <rsweb:ReportViewer ID="rvr" runat="server" Font-Size="8pt" Height="400px" Visible="False"
                        ...
                        <LocalReport ReportPath="UserAuditReport\rptAR003GetNonIcsUserUnsuccessfulLogin.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RoleDetails" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetNonIcsUserUnsuccessfulLogin"
