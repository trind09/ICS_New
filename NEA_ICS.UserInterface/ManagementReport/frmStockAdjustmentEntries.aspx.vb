...
Partial Public Class frmStockAdjustmentEntries
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                AccessRights = clsCommonFunction.AssignAccessRights(Cache(Session(ESession.UserID.ToString) & Session(ESession.StoreID.ToString) & "AccessRights"), _
                                        clsCommonFunction.moduleID.StockAdjustmentEntries)
    ...
    Protected Sub btnPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPDF.Click
        ...
        ' UAT02
        If ddlStockCodeFrom.SelectedValue = EMPTY And ddlStockCodeTo.SelectedValue = EMPTY Then
        ...
        rvr.LocalReport.DataSources.Add(New ReportDataSource("MR010StockAdjustmentEntriesDetails", ObjectDataSource1))
        ...
        Response.AddHeader("content-disposition", "attachment;filename=StockAdjustmentEntries.pdf")
    ...
    Protected Sub btnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExcel.Click
        ...
        Response.AddHeader("content-disposition", "attachment;filename=StockAdjustmentEntries.xls")
        Response.BinaryWrite(bytValue)
        Response.Flush()
        Response.End()
    ...
    Protected Sub ObjectDataSource1_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Selected
        Try
            Dim returnList As List(Of MR010StockAdjustmentEntriesDetails) = e.ReturnValue
